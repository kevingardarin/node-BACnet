...
const debug = require('debug')('testcode');
...
/**
 * To be able to communicate to BACNET devices, you have to initialize a new testcode instance.
 * @class testcode
 * @param {object=} this._settings - The options object used for parameterizing the testcode.
